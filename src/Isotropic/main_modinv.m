...
%========== Modified invariant based data driven formulation ==========%
...
[err_ut, err_et,err_ps,err_be, ~, ~,~,~,~] = ...
   object_modinv(control_pts,degree,lam_ut,lam_et,lam_ps,lam1_be,lam2_be,P_ut,P_et,P_ps,P1_be,P2_be);
...
[err_ut, err_et,err_ps,err_be, Pdata_ut, Pdata_et,Pdata_ps,Pdata1_be, Pdata2_be] = ...
   object_modinv(opt_control_pts,degree,lam_ut,lam_et,lam_ps,lam1_be,lam2_be,P_ut,P_et,P_ps,P1_be,P2_be);

[~, ~,~,~, Pdata_ut_ext, Pdata_et_ext,Pdata_ps_ext,Pdata1_be_ext, Pdata2_be_ext] = ...
   object_modinv(opt_control_pts,degree,lam_ut_ext,lam_et_ext,lam_ps_ext,lam1_be_ext,lam2_be_ext,0,0,0,0,0);
